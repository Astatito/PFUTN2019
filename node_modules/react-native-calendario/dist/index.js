...
export default class Calendar extends React.Component {
  ...
  componentWillMount() {
    ...
    if (start) {
      const firstMonth = months.find(m => m.monthNumber === start.getMonth() && m.year === start.getFullYear());
