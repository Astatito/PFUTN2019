...
var flatListData = [
    {key: 'wulefb43oy',nombre: 'Alexis', apellido: 'Pagura', documento: '39.645.758' , fechaDesde: '02/11/2018 20:00 hs', fechaHasta: '02/11/2018 23:00 hs'},
    {key: 'kqedufhkdu',nombre: 'Fabián', apellido: 'Guidobaldi',documento: '40.875.659' , fechaDesde: '02/11/2018 20:00 hs', fechaHasta: '02/11/2018 23:00 hs'},
    {key: '237r8h2eff',nombre: 'Ezequiel', apellido: 'Braicovich',documento: '39.645.569 ' , fechaDesde: '02/11/2018 20:00 hs', fechaHasta: '02/11/2018 23:00 hs'},
]
        ...
        return (
            <Swipeout {...swipeOutSettings} >
                <ListItem avatar>
                        ...
                        <Body>
                            <Text> {this.props.item.nombre + ' ' + this.props.item.apellido} </Text>
                            <Text> {this.props.item.documento} </Text>
                        </Body>
                        <Right>
                            <Text note> {this.props.item.fechaDesde} </Text>
                            <Text note> {this.props.item.fechaHasta} </Text>
                        </Right>
                </ListItem>
            </Swipeout>
        );
